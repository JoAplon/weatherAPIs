    ...
    fetch("https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&appid=1d59d123b21d759ac3f9305f57e76274&units=imperial")
        ...
        .then(function (data) {
            ...
            for (let i = 0; i < data.list.length; i += 8) {
                ...
                if (forecastDate > tomorrowDate && count < 5) {
                    const createCard = document.createElement('div');
                    ...
                    forecastHeader.classList.add('forecastHeader');
                    ...
                    forecastHeader.appendChild(dayElement);
                    forecastHeader.appendChild(iconElement);



                    createCard.appendChild(forecastHeader);
                    createCard.appendChild(createP1);
                    createCard.appendChild(createP2);
                    createCard.appendChild(createP3);
